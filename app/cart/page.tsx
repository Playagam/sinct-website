  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
      ...
      <div className="space-y-4">
        {items.map(item => (
          <div
            key={`${item.product.sin}-${item.size}`}
            className="glass noise border border-white/5 rounded-xl p-4 flex flex-wrap items-center gap-4"
          >
            ...
            <button
              onClick={() => removeFromCart(item.product.sin, item.size)}
